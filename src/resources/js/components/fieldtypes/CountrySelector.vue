...
export default {
    ...
    mounted() {
        ...
        let locale = this.config.language;
        let supported = ['af', 'am', 'ar', 'az', 'be', 'bg', 'bn', 'bs', 'ca', 'cs', 'da', 'de', 'en', 'es', 'et', 'fa', 'fi', 'fr', 'gl', 'el', 'ha', 'he', 'hi', 'hr', 'hu', 'hy', 'is', 'it', 'id', 'ja', 'ka', 'kk', 'km', 'ko', 'ku', 'ky', 'lt', 'lv', 'mk', 'ml', 'mn', 'ms', 'nb', 'nl', 'nn', 'no', 'pl', 'ps', 'pt', 'ro', 'ru', 'sd', 'sk', 'sl', 'so', 'sq', 'sr', 'sv', 'ta', 'tg', 'th', 'tr', 'tt', 'ug', 'uk', 'ur', 'uz', 'zh', 'vi'];
        ...
        supported.forEach((value) => {
            countries.registerLocale(require("i18n-iso-countries/langs/" + value + ".json"));
        })

        const objectArray = Object.entries(countries.getNames(locale, {select: "official"}));
